...
export class Migration20211219155639 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `bike` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null, `type` varchar(255) not null, `price` bigint not null, `image` longblob) default character set utf8mb4 engine = InnoDB;');
